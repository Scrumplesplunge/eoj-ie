...
slang.Hook.Add( "Initialize" , "MouseListener" , function( ) {
	...
	slang.Event.Hook( document.body, "mousedown", function( e ) {
		slang.Mouse.down = true;
	} );
	slang.Event.Hook( document.body, "mouseup", function( e ) {
		slang.Mouse.down = false;
	} );
} );
